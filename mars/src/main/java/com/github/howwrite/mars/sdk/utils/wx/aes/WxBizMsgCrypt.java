...
public class WxBizMsgCrypt {
    ...
    public WxBizMsgCrypt(String token, String encodingAesKey, String appId) {
        if (encodingAesKey.length() != ENCODING_AES_KEY_LENGTH) {
            throw new MarsEncryptException("aes key illegal, please check config mars.weixin.encoding-aes-key");
        }
    ...
    String encrypt(String randomStr, String text) {
        ...
        try {
            ...
            throw new MarsEncryptException("aes Encryption failed", e);
        }
    }
    ...
    String decrypt(String text) {
        ...
        try {
            ...
            throw new MarsEncryptException("aes decryption failed", e);
        }
        ...
        try {
            ...
            throw new MarsEncryptException("The buffer obtained after decryption is illegal", e);
        }

        // appid不相同的情况
        if (!fromAppid.equals(appId)) {
            throw new MarsEncryptException("appid verification failed");
        }
        return xmlContent;
    ...
    public String decryptMsg(String signature, String timeStamp, String nonce, String postData) {
        ...
        if (!decryptSignature.equals(signature)) {
            throw new MarsEncryptException("Signature verification error");
        }
